...
const RowOptions = ({
  ...
  const modalEstacionUpdate = useModalRequest(state => state.modalEstacionUpdate)
...
const EstacionesPage = () => {
  ...
  const columns: GridColDef[] = [
...

    {
      ...
      renderCell: ({ row }: CellType) => (
        <RowOptions data={row} setIsModal={setIsModal} setDataEstacion={setDataEstacion} refetch={refetch} />
      )
    }
  ]
  ...
  return (
    <Grid container spacing={6.5}>
      ...
      <AddUserDrawer open={isModal} toggle={toggleAddUserDrawer} dataEstacion={dataEstacion} refetch={refetch} />
    </Grid>
  )
}
