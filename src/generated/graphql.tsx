...
export type CreateCargoMutation = {
  ...
  createCargo?: {
    __typename?: 'CargoEntityResponse'
    data?: { __typename?: 'CargoEntity'; id?: string | null } | null
  } | null
}
...
export type CreateEstacioneMutation = {
  __typename?: 'Mutation'
  createEstacione?: {
    __typename?: 'EstacioneEntityResponse'
    data?: { __typename?: 'EstacioneEntity'; id?: string | null } | null
  } | null
}
...
export type DeleteEstacioneMutation = {
  __typename?: 'Mutation'
  deleteEstacione?: {
    __typename?: 'EstacioneEntityResponse'
    data?: { __typename?: 'EstacioneEntity'; id?: string | null } | null
...
export type UpdateEstacioneMutation = {
  __typename?: 'Mutation'
  updateEstacione?: {
    __typename?: 'EstacioneEntityResponse'
    data?: { __typename?: 'EstacioneEntity'; id?: string | null } | null
...
export type CreatePedidoMutation = {
  ...
  createPedido?: {
    __typename?: 'PedidoEntityResponse'
    data?: { __typename?: 'PedidoEntity'; id?: string | null } | null
  } | null
}
...
export type CreateUsersPermissionsUserMutation = {
  __typename?: 'Mutation'
  ...
  pedido?: {
    ...
    data?: {
      ...
      attributes?: {
        ...
        estacionFin?: string | null
        cuantoTardoInicioFin?: string | null
        estado?: boolean | null
        fehcaInicio?: string | null
        ...
        cargo?: {
          ...
          data?: {
            __typename?: 'CargoEntity'
            id?: string | null
            attributes?: { __typename?: 'Cargo'; nombre?: string | null } | null
          } | null
        } | null
      } | null
    } | null
    ...
    data?: {
      ...
      attributes?: {
        ...
        turnos?: {
          ...
          data: Array<{
            __typename?: 'TurnoEntity'
            attributes?: { __typename?: 'Turno'; fin?: any | null; inicio?: any | null; nombre?: string | null } | null
          }>
        } | null
      } | null
    } | null
...
export function useCreateCargoMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateCargoMutation, CreateCargoMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useDeleteCargoMutation(
  baseOptions?: Apollo.MutationHookOptions<DeleteCargoMutation, DeleteCargoMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useUpdateCargoMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateCargoMutation, UpdateCargoMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
`
export type CreateEstacioneMutationFn = Apollo.MutationFunction<
  CreateEstacioneMutation,
  CreateEstacioneMutationVariables
>
 ...
 * });
 */
export function useCreateEstacioneMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateEstacioneMutation, CreateEstacioneMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export type CreateEstacioneMutationOptions = Apollo.BaseMutationOptions<
  CreateEstacioneMutation,
  CreateEstacioneMutationVariables
>
...
`
export type DeleteEstacioneMutationFn = Apollo.MutationFunction<
  DeleteEstacioneMutation,
  DeleteEstacioneMutationVariables
>
 ...
 * });
 */
export function useDeleteEstacioneMutation(
  baseOptions?: Apollo.MutationHookOptions<DeleteEstacioneMutation, DeleteEstacioneMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export type DeleteEstacioneMutationOptions = Apollo.BaseMutationOptions<
  DeleteEstacioneMutation,
  DeleteEstacioneMutationVariables
>
...
`
export type UpdateEstacioneMutationFn = Apollo.MutationFunction<
  UpdateEstacioneMutation,
  UpdateEstacioneMutationVariables
>
 ...
 * });
 */
export function useUpdateEstacioneMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateEstacioneMutation, UpdateEstacioneMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export type UpdateEstacioneMutationOptions = Apollo.BaseMutationOptions<
  UpdateEstacioneMutation,
  UpdateEstacioneMutationVariables
>
...
export function useCreatePedidoMutation(
  baseOptions?: Apollo.MutationHookOptions<CreatePedidoMutation, CreatePedidoMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
 ...
 * });
 */
export function useDeletePedidoMutation(
  baseOptions?: Apollo.MutationHookOptions<DeletePedidoMutation, DeletePedidoMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export type DeletePedidoMutationOptions = Apollo.BaseMutationOptions<
  DeletePedidoMutation,
  DeletePedidoMutationVariables
>
...
export function useUpdatePedidoMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdatePedidoMutation, UpdatePedidoMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export type UpdatePedidoMutationOptions = Apollo.BaseMutationOptions<
  UpdatePedidoMutation,
  UpdatePedidoMutationVariables
>
...
`
export type CreateUsersPermissionsUserMutationFn = Apollo.MutationFunction<
  CreateUsersPermissionsUserMutation,
  CreateUsersPermissionsUserMutationVariables
>
 ...
 * });
 */
export function useCreateUsersPermissionsUserMutation(
  ...
  return Apollo.useMutation<CreateUsersPermissionsUserMutation, CreateUsersPermissionsUserMutationVariables>(
    CreateUsersPermissionsUserDocument,
    options
  )
}
...
export type CreateUsersPermissionsUserMutationOptions = Apollo.BaseMutationOptions<
  CreateUsersPermissionsUserMutation,
  CreateUsersPermissionsUserMutationVariables
>
...
export function useEstacionesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<EstacionesQuery, EstacionesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
